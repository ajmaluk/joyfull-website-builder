...
- 🎯 Smart usage tracking and credit system
- 💳 Subscription management with pro features
- 🔐 Authentication with Clerk
- ⚙️ Background job processing with Inngest
- 🗃️ Project management and persistence with Supabase
...
- Shadcn/ui
- tRPC
- Supabase SDK (Database & Persistence)
- PostgreSQL
...
- `src/types/` - Unified project types
